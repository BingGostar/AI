...
3.概率论(包含概率论、数理统计、随机过程)与信息论

4.最优化方法

5.图论/离散数学

6.实变函数，泛函分析，微分几何，偏微分方程
```

### 数学资料
```
1、高等数学/微积分
    (1) 微积分（先修课）(清华大学 2019秋)
        https://next.xuetangx.com/learn/THU07011000397/THU07011000397/1184838/video/796733

    (2) 蜂考 高数 微积分 上下
        https://fengkao.ke.qq.com/
